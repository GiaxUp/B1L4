...
public class Dipendente {
	...
	public Livello promuovi() {
		...
		case QUADRO:
			...
			break;
		case DIRIGENTE:
			System.out.println("Il dipendente " + matricola + " è già un dirigente.");
			break;
		}
		return livello;
	}
	...
	public static double calcolaPaga(Dipendente dipendente, int oreStraordinario) {
		double pagaBase = dipendente.stipendio;
		double importoOrarioStraordinario = dipendente.importoOrarioStraordinario;
		double pagaStraordinari = oreStraordinario * importoOrarioStraordinario;
		return pagaBase + pagaStraordinari;
	}
